...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'../Downloads/Pirjo/RDM/Porsanger museum, Utstilling Elvebåt 21.03.2017.docx'"/>
   ...
   <language xml:lang="fkv"/>    <language xml:lang="nob"/>
    </xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="porsanger_museum_utstilling_elvebat_21.03.2017.docx"/>
