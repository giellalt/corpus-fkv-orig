...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Kari Digre_Saunaer i Nordreisa_Oversatt til kvensk 05.06.2012  uten bokstaven đ.doc'"/>
    ...
    -->
    <xsl:variable name="translated_from" select="'noc'"/>
