...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Kieliviesti Räisänen 02112019.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kväänin kieli, sen tila ja revitalisaatio'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Anna-Kaisa'"/>
    <xsl:variable name="author1_ln" select="'Räisänen'"/>
    <!-- m, f or unknown -->
    ...
    <language xml:lang="fkv"/></xsl:variable>
