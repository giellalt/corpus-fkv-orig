...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Velkommen'"/>
    <!--
    ...
    <language xml:lang="sme"/><language xml:lang="eng"/><language xml:lang="fin"/><language xml:lang="fkv"/><language xml:lang="nob"/></xsl:variable>
