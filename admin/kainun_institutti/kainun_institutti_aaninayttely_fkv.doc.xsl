...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Lydutstilling, kvensk, samisk, finsk, norsk'"/>
    <!--
    ...
    <language xml:lang="nob"/><language xml:lang="sme"/><language xml:lang="fkv"/><language xml:lang="fin"/></xsl:variable>
