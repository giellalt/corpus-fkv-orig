...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Nasjonale_kvenskmidler_Driftstilskudd3Rapporteringsskjema.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nasjonale kvenskmidler Driftstilskudd rapporteringsskjema'"/>
    <!--
    ...
    <xsl:variable name="translator_ln" select="'Keränen'"/>
    <xsl:variable name="translator_gender" select="'f'"/>
    <xsl:variable name="translator_born" select="'1979'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nasjonale_kvenskmidler_driftstilskudd3rapporteringsskjema.odt"/>
