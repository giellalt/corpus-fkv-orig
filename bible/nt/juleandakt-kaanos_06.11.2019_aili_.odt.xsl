...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Juleandakt-käänös 06.11.2019, Aili .docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jumalan mitta'"/>
    <!--
    ...
    <xsl:variable name="sub_name" select="'Aili Eriksen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="juleandakt-kaanos_06.11.2019_aili_.odt"/>
